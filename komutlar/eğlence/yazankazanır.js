...
const words = ['çikolata', 'vortex', 'odun', 'bomba', 'süt', 'şimşek', 'yıldırım', 'patlat', 'savaş', 'kelime', 'yok et', 'bilmem', 'öldür', 'sonsuzluk', 'gerçek','SonerGameX','berat','kadir','hasan','furkan','mümin'];
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['yazı-yarışı',"yazan", 'ilk-yazan-kazanır','kelime-yarışması'],
  permLevel: 0,
  kategori: "eğlence"
};
