...
exports.run = async(client, message, args) => {
    ...
    message.channel.bulkDelete(sa).then(() => {
        ...
        .setDescription(`<a:Onay1:827821773252067400>**Başarıyla ${sa} Mesaj ${message.author} Tarafından Silindi !**`)
        .setColor("RANDOM")
        message.channel.send(sj).then(msg => msg.delete({timeout : 10000}))
    })
}
