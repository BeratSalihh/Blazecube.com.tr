...
let salvoembed = new Discord.MessageEmbed().setColor(0x7997ff).setFooter(`Blaze Cube`).setAuthor(message.author.username, message.author.avatarURL({dynamic: true}))
